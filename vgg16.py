...
if __name__ == '__main__':
	pass
	t_loc = 'C:\\Users\\lukas\\Documents\\Kaggle\\Cat_V_Dog\\Testing\\train\\'
	v_loc = 'C:\\Users\\lukas\\Documents\\Kaggle\\Cat_V_Dog\\Testing\\validation\\'
...
# 	loss += train(data, results, 1e-3)

# print(loss/3)

# for val_batch in validation_batches[:1]:
# 	val_data = []
# 	val_results = np.zeros(batch_size, dtype=np.int8)
